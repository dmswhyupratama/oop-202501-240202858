...
public class CashierView {
    ...
    // [BARU] Tombol Registrasi Member
    private Button btnRegisterMember = new Button("+ Member"); 
    ...
    public Parent asParent() {
        ...
        // [BARU] Style Tombol Register (Hijau Fresh)
        btnRegisterMember.setStyle("-fx-background-color: #27ae60; -fx-text-fill: white; -fx-font-weight: bold; -fx-cursor: hand;");
        ...
        // Baris 0: Voucher & Register Member (DIBUAT SEJAJAR)
        HBox voucherBox = new HBox(5);
        voucherBox.setAlignment(Pos.CENTER_RIGHT);
        // [UPDATE] Menambahkan btnRegisterMember ke layout
        voucherBox.getChildren().addAll(txtVoucher, btnCheckVoucher, btnRegisterMember); 
    ...
    // GETTER BARU (VOUCHER & REGISTER)
    public TextField getTxtVoucher() { return txtVoucher; }
    public Button getBtnCheckVoucher() { return btnCheckVoucher; }
    // [BARU] Getter untuk tombol register
    public Button getBtnRegisterMember() { return btnRegisterMember; }
